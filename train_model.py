...
# Train the model
model.fit(X_train, y_train, epochs=1000, callbacks=[tb_callback, reduce_lr])

#save model so predictions can be made
model.save('sign_language_detection_model_v2.h5')
